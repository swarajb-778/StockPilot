    ...
    <div className={sidebarClassNames}>
      ...
      >
        ...
        <h1
          ...
          } font-extrabold text-xl bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent`}
        >
          StockPilot
        </h1>
      ...
      <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
        <p className="text-center text-xs text-gray-500">&copy; 2025 StockPilot - Made by Swaraj</p>
      </div>
    </div>
  );
};
